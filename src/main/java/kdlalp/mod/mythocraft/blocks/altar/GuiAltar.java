...
public class GuiAltar extends GuiContainer
{
    ...
    {
        super(new ContainerAltar(p_i1084_1_, p_i1084_2_, p_i1084_3_, p_i1084_4_, p_i1084_5_));
    }
    ...
    {
        this.fontRendererObj.drawString(I18n.format("container.altar", new Object[0]), 28, 6, 4210752);
